                        ...
                        <div className="p-4 sm:p-6 rounded-lg border">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
                                ...
                                <div>
                                    ...
                                    <p>Status:{orderDetails.shippingMethod ? "Paid" : "UnPaid"}</p>
                                        ...
                                        {orderDetails.orderItems.map((item) => (
                                            <tr key={item.productId} className="border-b">
                                                <td className="py-2 px-4 flex items-center">
                                                    ...
                                                    <NavLink to={`/product/${item.productId}`} className="text-blue-500 text-sm hover:underline">{item.name}</NavLink>
                                                </td>
                            ...
                            {/* back to order */}
                            <NavLink to={"my-orders"} className="text-sm text-blue-500 hover:underline">
                                Back to My Orders
                            </NavLink>
                        </div>)}
                </h2>
